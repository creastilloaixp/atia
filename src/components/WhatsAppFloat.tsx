  ...
  return (
    <div className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-[90] flex items-end gap-3">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_32px_rgba(37,211,102,0.5)] transition-shadow relative"
